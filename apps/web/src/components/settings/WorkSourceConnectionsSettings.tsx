...
function AddConnectionDialog({
  ...
  const [jiraDeployment, setJiraDeployment] =
    useState<ConnectionFormState["jiraDeployment"]>("cloud");
        ...
        <DialogPanel className="space-y-4">
          <label className="block">
            ...
            <select
              ...
              disabled={submitting}
              onChange={(e) =>
                setProvider(e.currentTarget.value as ConnectionFormState["provider"])
              }
            >
            ...
            <>
              <label className="block">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setJiraDeployment(
                      e.currentTarget.value as ConnectionFormState["jiraDeployment"],
                    )
                  }
                >
        ...
        {loadError ? (
          ...
          <div className={ITEM_ROW_CLASSNAME}>
            <p className="text-sm text-muted-foreground">
              No work-source connections yet. Add one to start syncing GitHub issues, Asana tasks,
              or Jira issues.
            </p>
          </div>
        ) : (
