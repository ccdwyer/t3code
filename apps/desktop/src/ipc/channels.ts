...
export const CODEX_MICRO_GET_STATE_CHANNEL = "desktop:codex-micro-get-state";
export const CODEX_MICRO_SET_AGENT_KEY_COLORS_CHANNEL = "desktop:codex-micro-set-agent-key-colors";
export const CODEX_MICRO_SET_BRIGHTNESS_CHANNEL = "desktop:codex-micro-set-brightness";
export const CODEX_MICRO_SET_AUTO_DIM_CHANNEL = "desktop:codex-micro-set-auto-dim";
export const CODEX_MICRO_STATE_CHANNEL = "desktop:codex-micro-state";
