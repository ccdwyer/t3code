...
export const WorkflowStep = Schema.Union([AgentStep, ApprovalStep, ScriptStep, MergeStep, PullRequestStep]);
...
export const WorkflowSaveBoardDefinitionInput = Schema.Struct({
  ...
  source: Schema.optional(Schema.Literals(["save", "revert"])),
});
...
export const WorkflowRouteDecisionView = Schema.Struct({
  ...
  toLane: LaneKey,
  source: Schema.Literals(["step_on", "lane_transition", "lane_on", "manual", "external_event", "work_source"]),
  matchedTransitionIndex: Schema.optional(Schema.Int),
