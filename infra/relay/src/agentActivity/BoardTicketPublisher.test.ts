    ...
    Layer.provide(
      Layer.mergeAll(
        ...
        Layer.succeed(
          ...
          makeLiveActivities({
            listTargets: () => Effect.succeed(input.targets),
          }),
        ),
      ...
      return Effect.gen(function* () {
        ...
        Effect.provide(
          provide({
            targets: [
              target({
                preferences_json: preferences({ notifyOnApproval: false }),
              }),
            ],
            capture,
          }),
      ...
      return Effect.gen(function* () {
        ...
        Effect.provide(
          provide({
            targets: [
              target({
                preferences_json: preferences({ notifyOnBlocked: false }),
              }),
            ],
            capture,
          }),
    ...
    return Effect.gen(function* () {
      ...
      Effect.provide(
        provide({
          targets: [
            target({
              preferences_json: preferences({ notificationsEnabled: false }),
            }),
          ],
          capture,
        }),
