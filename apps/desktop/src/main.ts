...
const desktopApplicationLayer = Layer.mergeAll(
  ...
  // Self-contained: the device layer provides its own node-hid transport +
  // powerMonitor. Started + torn down via installCodexMicroStateForwarding.
  CodexMicroDevice.layer,
  desktopSshLayer,
).pipe(
