...
const restartExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "code blew up",
}));
...
const unlimitedExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "boom",
}));
...
const runLaneExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "boom",
}));
...
const scriptParkedExecutor = makeScriptedExecutor(() => ({
  _tag: "completed",
}));
