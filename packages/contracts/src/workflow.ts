...
export const WORKFLOW_WS_METHODS = {
  ...
  createMockSlackAgentInstance: "workflow.createMockSlackAgentInstance",
  connectSlackAgentInstance: "workflow.connectSlackAgentInstance",
  disconnectSlackAgentInstance: "workflow.disconnectSlackAgentInstance",
  testSlackAgentConnection: "workflow.testSlackAgentConnection",
