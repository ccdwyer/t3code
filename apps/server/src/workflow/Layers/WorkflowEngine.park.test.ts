...
const stepFailPark = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "code blew up",
}));
...
const laneOnFail = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "kaboom",
}));
...
const skipExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "boom",
}));
...
const longFailExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: longError,
}));
...
const answerParkExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "boom",
}));
...
const f3ActionParkExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "boom",
}));
...
const f3bActionParkExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "boom",
}));
