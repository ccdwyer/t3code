  ...
  switch (event.type) {
    ...
    case "TicketContextPackEdited":
      return {
        ...
        category: "human",
        actor: "user",
        summary: "Handoff context edited",
      };
    default:
