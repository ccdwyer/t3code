        ...
        actions: [
          {
            label: "Approve spec",
            to: "plan",
            hint: "Read SPEC.md, then continue to planning.",
          },
          {
            label: "Request changes",
            to: "brainstorm",
            hint: "Send it back for another pass.",
          },
        ],
      },
      {
        ...
        ...(input.withAiReview
          ? {
              transitions: [
                ...
                {
                  when: {
                    "==": [{ var: "steps.build-review.output.verdict" }, "approve"],
                  },
                  to: "done",
                },
              ],
        ...
        actions: [
          {
            label: "Retry",
            to: "build",
            hint: "Run another build + review pass.",
          },
