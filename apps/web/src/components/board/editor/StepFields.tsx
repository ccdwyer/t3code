    ...
    <div className="grid gap-3 @2xl:grid-cols-2">
      ...
      {step.action === "open" ? (
        <>
          ...
          <p className="text-xs text-muted-foreground @2xl:col-span-2">
            Pushes the ticket&apos;s branch and opens a pull request. Conflicts or missing
            remotes block the ticket instead of failing it.
          </p>
        </>
      ) : null}
      {step.action === "land" ? (
        <>
          ...
          <p className="text-xs text-muted-foreground @2xl:col-span-2">
            Lands the ticket&apos;s PR via{" "}
            <code className="font-mono">gh pr merge</code>; red checks or conflicts block the
            ticket instead of failing it.
          </p>
        </>
      ) : null}
    </div>
