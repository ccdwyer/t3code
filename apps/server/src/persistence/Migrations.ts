...
import Migration0036 from "./Migrations/036_ThreadOwner.ts";
import Migration0037 from "./Migrations/037_PluginMigrations.ts";
import Migration0038 from "./Migrations/038_PluginSettings.ts";
...
export const migrationEntries = [
  ...
  [36, "ThreadOwner", Migration0036],
  [37, "PluginMigrations", Migration0037],
  [38, "PluginSettings", Migration0038],
] as const;
