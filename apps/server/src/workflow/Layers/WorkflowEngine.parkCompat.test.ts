...
const LEGACY_DEFAULT_BOARD_FIXTURE = {
  ...
  lanes: [
    ...
    },
    {
      ...
      on: {
        success: "specifying",
        failure: "planning_issues",
        blocked: "planning_issues",
      },
    },
    {
      key: "specifying",
...
const legacyExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "boom",
}));
...
const replayEvents = (ticketId: string) =>
  [
    ...
    },
    {
      ...
      payload: {
        toLane: "impl",
        laneEntryToken: "tok-replay-compat-1",
        reason: "manual",
      },
    },
    {
    ...
    },
    {
      ...
      payload: {
        toLane: "impl",
        laneEntryToken: "tok-replay-compat-2",
        reason: "manual",
      },
    },
  ] as const;
...
const mixedExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "code blew up",
}));
...
const revertExecutor = makeScriptedExecutor(() => ({
  _tag: "failed",
  error: "code blew up",
}));
