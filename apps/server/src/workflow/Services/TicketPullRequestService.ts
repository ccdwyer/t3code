...
export interface TicketPullRequestServiceShape {
  readonly open: (input: TicketPullRequestInput) => Effect.Effect<StepOutcome, WorkflowEventStoreError>;
  readonly land: (input: TicketPullRequestInput) => Effect.Effect<StepOutcome, WorkflowEventStoreError>;
}
