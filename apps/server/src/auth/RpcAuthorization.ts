...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WORKFLOW_WS_METHODS.listSlackAgentInstances]: AuthOrchestrationReadScope,
  [WORKFLOW_WS_METHODS.createSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.createMockSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.connectSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.disconnectSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.testSlackAgentConnection]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.updateSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.disableSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.enableSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.deleteSlackAgentInstance]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.simulateSlackMention]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.getSlackAgentRun]: AuthOrchestrationReadScope,
  [WORKFLOW_WS_METHODS.subscribeSlackAgentRun]: AuthOrchestrationReadScope,
  [WORKFLOW_WS_METHODS.retrySlackAgentDelivery]: AuthOrchestrationOperateScope,
  [WORKFLOW_WS_METHODS.subscribeMockSlackThread]: AuthOrchestrationReadScope,
